...
import { View, FlatList, StyleSheet, TouchableOpacity, InteractionManager } from 'react-native';
...
import ItemImageLibrary from 'App/Components/ModalSelectImage/ItemImageLibrary';

interface IProps {
  isVisible: boolean;
  onClose: () => void;
  setImagePicker: (data: Image) => void;
}

const ModalSelectImage: FC<IProps> = ({ isVisible, onClose, setImagePicker }) => {
  ...
  const renderItem = useCallback(
    ({ item }) => {
      ...
      return <ItemImageLibrary handleClickImage={handleClickImage} item={item} />;
    },
  ...
  return (
    <ModalBottomSheet onClose={onClose} propagateSwipe isVisible={isVisible}>
