...
export default class MultiSlider extends React.Component {
  static defaultProps = {
    ...
    onChunkValuesChange: chunkValues => {},
  ...
  constructor(props) {
    ...
    // console.log('size old', this.optionsArray, this.stepLength, this.props.markerSize)
  ...
  moveOne = gestureState => {
    ...
    console.log('past old', this.state.pastOne);
    ...
    if (Math.abs(accumDistanceDisplacement) < slipDisplacement || !slipDisplacement) {
      ...
      console.log('gestureState', gestureState, confined);
      ...
      // console.log('snapped old', snapped, confined)
      this.setState({
  ...
  endOne = gestureState => {
    ...
    var snapped = valueToPosition(this.state.valueOne, this.optionsArray, this.props.sliderLength);
    ...
    this.setState(
      () => {
        ...
        console.log('newState.pastOne', newState.pastOne);
        return newState;
      },
      () => {
        var change = [this.state.valueOne];
  ...
  endTwo = gestureState => {
    ...
    var snapped = valueToPosition(this.state.valueTwo, this.optionsArray, this.props.sliderLength);
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      ...
      (prevProps.sliderLength !== this.props.sliderLength && prevProps.values[1])
    ) {
